<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark"><!--navegacion-->
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Mi casita bonita</a>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              ...
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="ingresarProductos.php">Productos</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="#">Tiendas</a>
              </li>
              <li class="nav-item">
